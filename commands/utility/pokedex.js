...
module.exports = {
    ...
    let poke_name = poke_data.name; // Atribuição correta
	...
	const poke_desc = descData.flavor_text_entries["0"].flavor_text;
...
const pokedex = new EmbedBuilder()
	...
	.setImage(`${poke_image}`)
	.addFields(
		{ name: 'Type', value: `${poke_types}`, inline: true },
	)
    await interaction.reply({embeds: [pokedex]})
	},
};
